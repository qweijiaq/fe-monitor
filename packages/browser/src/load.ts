...
import { htmlElementAsString, Severity } from 'wj-fe-monitor-utils';
import { EventTypes, BreadCrumbTypes } from 'wj-fe-monitor-shared';
import { breadcrumb, handleConsole } from 'wj-fe-monitor-core';
