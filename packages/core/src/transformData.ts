import { BreadCrumbTypes, ErrorTypes, globalVar } from 'wj-fe-monitor-shared';
import {
  getLocationHref,
  getTimestamp,
  Severity,
...
import { ReportDataType, MonitorHttp, Replace, ResourceErrorTarget } from 'wj-fe-monitor-types';
